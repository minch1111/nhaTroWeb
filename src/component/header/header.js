        ...
        <div className="container-fluid">
            <div className="row header1">
                ...
                <div className="col-md-6 col-sm-6 col-xs-6 header1_info_right">
                    <LoginRegister clickPostNewstoApp={props.clickPostNewstoApp} clickMovedOnUsertoApp={props.clickMovedOnUsertoApp} />
            ...
            <div className="row header2">
                <div className="row header2-slide-menu" id={!props.stateFiterandslide_imgApp ? "header2-menu" : ""}>
            ...
            {!props.stateFiterandslide_imgApp &&
                <div className="row">
                    <div className="container form_filter">
                        <Filter
                            // StateFiterTyhomeNews_TF={props.StateFiterTyhomeNews_TF}  // Hiện hoặc ẩn fitter
